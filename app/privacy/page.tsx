      ...
      <div className="mx-auto max-w-3xl px-4 pb-16 pt-10">
        ...
        <div className="mt-10 space-y-8 text-sm leading-relaxed text-zinc-300 sm:text-base">
          ...
          <section>
            ...
            <p className="mt-3">
              Только после вашего разрешения сайт подключает Google Analytics
              для оценки просмотров страниц и действий на сайте: перехода к
              форме записи, клика по телефону и успешной отправки формы. Имя,
              телефон, текст заявки, текст отзыва и прикреплённые изображения в
              аналитику не передаются. Вы можете изменить выбор кнопкой
